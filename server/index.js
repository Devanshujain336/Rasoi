...
// ── Health Check ──────────────────────────────────────────────────────────────
app.get("/api/ping", (req, res) => res.json({ message: "pong", version: "1.0.3", time: new Date().toISOString() }));
...
app.get("/", (req, res) => {
    res.send("Rasoi Backend API is running 🍛 [V1.0.3]");
});
...
app.listen(PORT, () => {
    console.log(`\n--------------------------------------`);
    console.log(`🚀 RASOI SERVER STARTED [VERSION 1.0.3]`);
